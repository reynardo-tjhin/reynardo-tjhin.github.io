...
- [Remove Claps](/github-repos/remove-claps/) ([Github Repository](https://github.com/reynardo-tjhin/remove-claps))
...
- [Sudoku Generator](/github-repos/sudoku-generator/) ([GitHub Repository](https://github.com/reynardo-tjhin/sudoku-generator))
...
- Sorting ([GitHub Repository](https://github.com/reynardo-tjhin/sorting))

    I remember I was sooo motivated to write sorting algorithms in C because I just completed [COMP2017: Systems Programming](https://www.sydney.edu.au/units/COMP2017) course. I was very proud of myself to pass the course with flying colors ☺️ because the course was notoriously known for failing many students.

- [Sudoku Solver](/github-repos/sudoku-generator/) ([GitHub Repository](https://github.com/reynardo-tjhin/sudoku-solver))

    Another small project that I did right after completing the [COMP2017: Systems Programming](https://www.sydney.edu.au/units/COMP2017) course. Well... I was into C back then for a good 6 months 🤗.
